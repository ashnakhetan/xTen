...
import { displayLoading, displayText } from "../../utils/display";
...
export class urlRecommenderPlugin {
    ...
    async recommendUrlsMonth() {
        ...
        // try gtting the urls, if it fails, display an error message
        try {
        ...
        // display the recommended urls in a tooltip in the middle of the page
        y = window.innerHeight / 2;
        displayText(recommendedUrls, x, y);
    }
